...
const docTemplate = `{
        ...
        "/analytics": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Aggregation period: week (default, last 7 days) or month (last 30 days)",
                        "name": "period",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Aggregation scope: mine (default) or all (admin only)",
                        "name": "scope",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.AnalyticsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.TimeSeriesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "internal_api.AnalyticsNeverClicked": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "internal_api.AnalyticsReferrer": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "internal_api.AnalyticsResponse": {
            "type": "object",
            "properties": {
                "never_clicked": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.AnalyticsNeverClicked"
                    }
                },
                "period": {
                    "type": "string"
                ...
                "top_links": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.AnalyticsTopLink"
                    }
                },
                "top_referrers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.AnalyticsReferrer"
                    }
                }
            }
        },
        "internal_api.AnalyticsTopLink": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "internal_api.TimeSeriesResponse": {
            "type": "object",
            "properties": {
                "days": {
                    "type": "integer"
                ...
                "series": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.TimeSeriesPoint"
                    }
                }
            }
        },
